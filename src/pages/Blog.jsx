      ...
      <div className='w-4/5 m-auto'>
        ...
        <div className='grid grid-cols-3 gap-5 md:grid-cols-1'>
          {courses.slice(0, 3).map((item, idx) => (
            <div key={idx} className='box rounded-lg shadow-shadow1 bg-white'>
              ...
              <div className='text p-3'>
                ...
                <div className='user flex items-center justify-between'>
                  <div className='flex items-center'>
                    <img className='rounded-full w-7 h-7 object-cover shadow-shadow1'
                         src='https://secure.gravatar.com/avatar/75ec18a5bf959aab895830be3a78cb34?s=50&d=mm&r=g'
                         alt=''/>
                    <span className='text-[14px] ml-2'> man</span>
                  </div>
                  <div className='flex items-center'>
                    <AiTwotoneCalendar/>
